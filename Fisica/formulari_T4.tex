...
$\overrightarrow{B} = \frac{1}{c}\left[ \overrightarrow{u} \times \overrightarrow{E} \right], \overrightarrow{E} = c \left[ \overrightarrow{B} \times \overrightarrow{u} \right]$. \\
\u{Apunt sobre el producte vectorial}: $\overrightarrow{c} = \left[ \overrightarrow{a} \times \overrightarrow{b} \right] \implies |c| = ab\sin\theta$ i $c \bot a,b$. \\
\u{Regla de la m\`a dreta}: polze = $\overrightarrow{c}$, \'index = $\overrightarrow{a}$, cor = $\overrightarrow{b}$. \\
