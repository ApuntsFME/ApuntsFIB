...
\u{\'Index de refracci\'o}: $n = \frac{c}{V}$, $V =$ velocitat de fase al medi. \\
...
\u{Al canviar de medi}: $f$ const., $V$ i $\lambda$ varien: $n_1 \lambda_1= n_2 \lambda_2$. \\
% TODO Problema 17
